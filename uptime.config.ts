...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/hekuo5310', label: 'GitHub' },
    { link: 'https://www.io.hk.cn/', label: '博客' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      name: 'OpenList',
      method: 'GET',
      target: 'https://oplist.io.hk.cn/',
      statusPageLink: 'https://oplist.io.hk.cn/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Telegram 代理',
      method: 'HEAD',
      target: 'https://web.tg.io.hk.cn/',
      statusPageLink: 'https://web.tg.io.hk.cn/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
